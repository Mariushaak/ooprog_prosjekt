...
#ifndef __LISTTOOL2A_H                  //  Ensures that this file will be
...
class Element {
  ...
  public:
    ...
    virtual ~Element()  {     }                  //  Virtual. Empty body.
    char getType()  {  return  elementType;  }   //  Return element type.
    virtual int compare(Element* element)  {
      element = element;  return 0;     //  Virtual. Dummy body.
    }
                                        //  Used only if function is NOT
    virtual void display()  {           //   redefined inside derived classes:
      cout << "\nLISTTOOL - WARNING:\n\t'Display()' not "
...
class NumElement: public Element  {
  ...
  public:
    NumElement()  {                     //  Needs and reads the ID-number.
      cout << "\nDato(aaaammdd):  ";   cin >> number;   cin.ignore();
      elementType = 'N';
    }
    ...
    NumElement(int no)  {               //  Created with an ID.
      number = no;  elementType = 'N';
                                        ...
                                        //  Compares own number with element's.
    virtual int compare(Element* element)  {
...
class TextElement: public Element  {
  ...
  public:
    TextElement()  {                          //  Needs/reads the ID-name/text.
      ...
      text = new char[strlen(id) + 1];  strcpy2(text, id);  elementType = 'T';
    }
    ...
    ~TextElement()  {                         //  Deletes the text ID.
      delete [] text;   
                                              ...
                                              //  Compares own name/text 
    virtual int compare(Element* element)  {  //    with element's.
